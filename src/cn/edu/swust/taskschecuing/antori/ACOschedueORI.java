...
public class ACOschedueORI {
	...
	public static void main(String[] args) throws Exception {
		...
		ExpData expData= ExpDataTool.get("E:/Cloudsim使用/任务调度/100task-5vm.json",0);
    	...
    	ACOORI aco = new ACOORI(expData.taskNum, expData.vmNum, 100,50, 1.f, 5.f, 0.5f);  
		aco.init(expData);
		aco.solve();
